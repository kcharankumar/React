...
class CreateEmployeeComponent extends Component
{
        ...
        if(this.state.id === '_add')
        {
            EmployeeService.createEmployee (employee).then (res => 
                { 
                  ...
                  this.props.history.push ('/employees'); //This is for routing to another page.                  
                });
        }
        else
        {
          // alert ("in saveOrUpdateEmployee of Update... id "+this.state.id) ; 
    ...
    {
      //alert ("in changeFirstNameHandler()")  ;
